...
REAL, DIMENSION(NIJT,NKT), INTENT(OUT) :: PT_OUT, PRV_OUT, PRC_OUT, PRI_OUT
REAL, DIMENSION(NIJT,NKT), INTENT(OUT) :: PCLDFR, ZQ1
REAL, DIMENSION(NIJT,NKT), INTENT(OUT) :: ZPV, ZPIV, ZFRAC
REAL, DIMENSION(NIJT,NKT), INTENT(OUT) :: ZQSL, ZQSI, ZSIGMA, ZCOND
REAL, DIMENSION(NIJT,NKT), INTENT(OUT) :: ZA, ZB, ZSBAR
