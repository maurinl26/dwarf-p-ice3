...
!-----------------------------------------------------------------
!     ##########################################################################
      SUBROUTINE ICE_ADJUST (NIJT, NKT, NIJB, NIJE, NKTE, NKTB, NKB, NKE, NKL, KRR, &
        &XCPD, XCPV, XCI, XCL, XLSTT, XLVTT, XTT, &
        &XG, XRD, XRV, XALPW, XBETAW, XGAMW, XALPI, XPI,  XBETAI, XGAMI, &
        &XCRIAUTI, XACRIAUTI, XBCRIAUTI, XCRIAUTC, &
        &XFRMIN, &
        &LSUBG_COND, LSIGMAS, LOCND2, LSTATNW, LHGT_QS, &
        &CCONDENS, CFRAC_ICE_ADJUST, CLAMBDA3, CSUBG_MF_PDF,&
        &PTSTEP, PSIGQSAT,                                 &
...
integer, intent(in) :: NIJT, NKT, NIJB, NIJE, NKTB, NKTE, NKB, NKE, NKL
real, intent(in) :: XCPD, XCPV, XCI, XCL, XLSTT, XLVTT, XTT
real, intent(in) :: XG, XRD, XRV, XALPW, XBETAW, XGAMW, XALPI, XPI,  XBETAI, XGAMI
real, intent(in) :: XCRIAUTI, XACRIAUTI, XBCRIAUTI, XCRIAUTC 
real, dimension(50), intent(in) :: XFRMIN
logical, intent(in) :: LSUBG_COND, LSIGMAS, LOCND2, LSTATNW, LHGT_QS
character(len=80), intent(in) :: CCONDENS, CFRAC_ICE_ADJUST, CLAMBDA3, CSUBG_MF_PDF
...
!   ZT is INOUT
CALL CONDENSATION(NIJT, NKT, NKB, NKE, NKL, NIJB, NIJE, &
&XTT, XLVTT, XLSTT, XCPV, XCI, XCL, XG, XRD, XRV, XALPW, XBETAW, XGAMW, XALPI, XPI,  XBETAI, XGAMI, &
&LSTATNW, LHGT_QS, &
&XCRIAUTI, XACRIAUTI, XBCRIAUTI, XCRIAUTC, XFRMIN,CFRAC_ICE_ADJUST,CCONDENS, CLAMBDA3, &
PPABST, PZZ, PRHODREF, ZT, PRV_IN, PRV_OUT, PRC_IN, PRC_OUT, PRI_IN, PRI_OUT, &
PRR, PRS, PRG, PSIGS, LMFCONV, PMFCONV, PCLDFR, &
PSRCS, .TRUE., LSIGMAS, LOCND2,                       &
