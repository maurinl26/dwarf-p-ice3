...
try:
    ...
    _command = (
        [_fort_compiler] + _ordered_dependencies + _compile_options + ["-o", _shared_object_name]
    )
    if _verbose:
...
class mode_ice4_rrhong:
    ...
    def ice4_rrhong(
        self, kproma, ksize, ldcompute, pexn, plvfact, plsfact, pt, prrt, ptht, prrhong_mr=None
    ):
        """!!
        !!**  PURPOSE
        !!    -------
