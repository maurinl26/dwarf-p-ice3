...
from ice3_gt4py.phyex_common.xker_raccs import KER_RACCSS, KER_RACCS, KER_SACCRG
...
def test_ice4_fast_ri(
    ...
    fortran_stencil = compile_fortran_stencil("mode_ice4_fast_ri.F90", "mode_ice4_fast_ri", "ice4_fast_ri")
    ...
    ai_gt4py = from_array(FloatFieldsIJK["ai"], dtype=gt4py_config.dtypes.float, backend=gt4py_config.backend)
    cj_gt4py = from_array(FloatFieldsIJK["cj"], dtype=gt4py_config.dtypes.float, backend=gt4py_config.backend)
    cit_gt4py = from_array(FloatFieldsIJK["cit"], dtype=gt4py_config.dtypes.float, backend=gt4py_config.backend)
    ssi_gt4py = from_array(FloatFieldsIJK["ssi"], dtype=gt4py_config.dtypes.float, backend=gt4py_config.backend)
    rct_gt4py = from_array(FloatFieldsIJK["rct"], dtype=gt4py_config.dtypes.float, backend=gt4py_config.backend)
    rit_gt4py = from_array(FloatFieldsIJK["rit"], dtype=gt4py_config.dtypes.float, backend=gt4py_config.backend)
    rc_beri_tnd_gt4py = from_array(FloatFieldsIJK["rc_beri_tnd"], dtype=gt4py_config.dtypes.float, backend=gt4py_config.backend)
...
def test_ice4_fast_rs(
    ...
    ice4_fast_rs = compile_stencil(
            "ice4_fast_rs", gt4py_config, externals
        )
    fortran_stencil = compile_fortran_stencil("mode_ice4_fast_rs.F90", "mode_ice4_fast_rs", "ice4_fast_rs")
    ...
    lbdas_gt4py = from_array(FloatFieldsIJK["lbdas"], dtype=gt4py_config.dtypes.float, backend=gt4py_config.backend)
    ...
    rst_gt4py = from_array(FloatFieldsIJK["rst"], dtype=gt4py_config.dtypes.float, backend=gt4py_config.backend)
    rcrimss_gt4py = from_array(FloatFieldsIJK["rcrimss"], dtype=gt4py_config.dtypes.float, backend=gt4py_config.backend)
    rcrimsg_gt4py = from_array(FloatFieldsIJK["rcrimsg"], dtype=gt4py_config.dtypes.float, backend=gt4py_config.backend)
    rsrimcg_gt4py = from_array(FloatFieldsIJK["rsrimcg"], dtype=gt4py_config.dtypes.float, backend=gt4py_config.backend)
    rraccss_gt4py = from_array(FloatFieldsIJK["rraccss"], dtype=gt4py_config.dtypes.float, backend=gt4py_config.backend)
    rraccsg_gt4py = from_array(FloatFieldsIJK["rraccsg"], dtype=gt4py_config.dtypes.float, backend=gt4py_config.backend)
    rsaccrg_gt4py = from_array(FloatFieldsIJK["rsaccrg"], dtype=gt4py_config.dtypes.float, backend=gt4py_config.backend)
    rs_mltg_tnd_gt4py = from_array(FloatFieldsIJK["rs_mltg_tnd"], dtype=gt4py_config.dtypes.float, backend=gt4py_config.backend)
    rc_mltsr_tnd_gt4py = from_array(FloatFieldsIJK["rc_mltsr_tnd"], dtype=gt4py_config.dtypes.float, backend=gt4py_config.backend)
    rs_rcrims_tnd_gt4py = from_array(FloatFieldsIJK["rs_rcrims_tnd"], dtype=gt4py_config.dtypes.float, backend=gt4py_config.backend)
    rs_rcrimss_tnd_gt4py = from_array(FloatFieldsIJK["rs_rcrimss_tnd"], dtype=gt4py_config.dtypes.float, backend=gt4py_config.backend)
    rs_rsrimcg_tnd_gt4py = from_array(FloatFieldsIJK["rs_rsaccrg_tnd"], dtype=gt4py_config.dtypes.float, backend=gt4py_config.backend)
    rs_rraccs_tnd_gt4py = from_array(FloatFieldsIJK["rs_rraccs_tnd"], dtype=gt4py_config.dtypes.float, backend=gt4py_config.backend)
    rs_rraccss_tnd_gt4py = from_array(FloatFieldsIJK["rs_rraccss_tnd"], dtype=gt4py_config.dtypes.float, backend=gt4py_config.backend)
    rs_rsaccrg_tnd_gt4py = from_array(FloatFieldsIJK["rs_rsaccrg_tnd"], dtype=gt4py_config.dtypes.float, backend=gt4py_config.backend)
    rs_freez1_tnd_gt4py = from_array(FloatFieldsIJK["rs_freez1_tnd"], dtype=gt4py_config.dtypes.float, backend=gt4py_config.backend)
    rs_freez2_tnd_gt4py = from_array(FloatFieldsIJK["rs_freez2_tnd"], dtype=gt4py_config.dtypes.float, backend=gt4py_config.backend)
        
    index_floor_gt4py = from_array(index_floor, dtype=gt4py_config.dtypes.float, backend=gt4py_config.backend)
    index_floor_r_gt4py = from_array(index_floor_r, dtype=gt4py_config.dtypes.float, backend=gt4py_config.backend)
    index_floor_s_gt4py = from_array(index_floor_s, dtype=gt4py_config.dtypes.float, backend=gt4py_config.backend)
        
    gaminc_rim1_gt4py = from_array(gaminc_rim1, dtype=gt4py_config.dtypes.float, backend=gt4py_config.backend)
    gaminc_rim2_gt4py = from_array(gaminc_rim2, dtype=gt4py_config.dtypes.float, backend=gt4py_config.backend)
    gaminc_rim4_gt4py = from_array(gaminc_rim4, dtype=gt4py_config.dtypes.float, backend=gt4py_config.backend)
...
@pytest.mark.parametrize("precision", ["double", "single"])
@pytest.mark.parametrize("backend", get_backends())
def test_ice4_fast_rg(gt4py_config, externals, fortran_packed_dims, precision, backend, grid, origin
):
        # Setting backend and precision
        gt4py_config.backend = backend
        gt4py_config.dtypes = gt4py_config.dtypes.with_precision(precision)
        ...
        fortran_stencil = compile_fortran_stencil("mode_ice4_fast_rg.F90", "mode_ice4_fast_rg", "ice4_fast_rg")
        ...
        fortran_stencil = compile_fortran_stencil("mode_ice4_fast_rg.F90", "mode_ice4_fast_rs", "ice4_fast_rs")
        ...
        F2Py_Mapping = {
           ...
           "ppres":"pres", 
            ...
            "priaggs":"riaggs",
            "prcrimss":"rcrimss",
            "prcrimsg":"rcrimsg", "prsrimcg":"rsrimcg",
            "prraccss":"rraccss", "prraccsg":"rraccsg", 
            "prsaccrg":"rsaccrg", "prsmltg":"rs_mltg_tnd",
