...
if __name__ == "__main__":
    ...
    fields = {
        ...
        "prrt": PRRT,
        "ptht": PTHT,
        "prrhong_mr": PRRHONG_MR,
    }

    logging.info(inspect.signature(mode_ice4_rrhong.mode_ice4_rrhong.ice4_rrhong))
    logging.info("Calling ice4_rrhong with dicts")

    mode_ice4_rrhong.mode_ice4_rrhong.ice4_rrhong(**externals, **fields)
